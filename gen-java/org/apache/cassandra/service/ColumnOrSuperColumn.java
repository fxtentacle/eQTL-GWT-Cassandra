 ...
 * instance of ColumnOrSuperColumn or a list of ColumnOrSuperColumns
 * (get_slice()). If you're looking up a SuperColumn (or list of SuperColumns)
 * then the resulting instances of ColumnOrSuperColumn will have the requested
 * SuperColumn in the attribute super_column. For queries resulting in Columns,
 * those values will be in the attribute column. This change was made between
 * 0.3 and 0.4 to standardize on single query methods that may return either a
...
public class ColumnOrSuperColumn implements TBase, java.io.Serializable, Cloneable, Comparable<ColumnOrSuperColumn> {
	 ...
	 */
		...
		{
			put(COLUMN, new FieldMetaData("column", TFieldRequirementType.OPTIONAL, new StructMetaData(TType.STRUCT, Column.class)));
			put(SUPER_COLUMN, new FieldMetaData("super_column", TFieldRequirementType.OPTIONAL, new StructMetaData(TType.STRUCT, SuperColumn.class)));
		}
	});
	...
	public ColumnOrSuperColumn(Column column, SuperColumn super_column) {
		this();
		this.column = column;
	...
	// Returns true if field column is set (has been asigned a value) and false
	// otherwise
	...
	// Returns true if field super_column is set (has been asigned a value) and
	// false otherwise
